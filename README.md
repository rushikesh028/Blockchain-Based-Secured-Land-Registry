...
- an ephemeral JWT signing key unless `APP_JWT_SECRET` is set
...
Keep `.env` out of version control and start from `.env.example`.
...
- Runtime logs, local environment files, and build output should not be committed to a public repository.
